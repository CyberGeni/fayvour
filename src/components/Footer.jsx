function Footer() {
  return (
    <footer className="space-y-3 sm:space-y-4 md:space-y-6 font-circular bg-[#EBEAED] px-[5%] sm:px-[7.5%] md:px-[10%] py-12 sm:py-14 md:py-20 lg:py-24">
      ...
      <a className="text-[#475467] underline my-3 md:my-4 block w-fit" href="mailto:fayvouraj@gmail.com">Email me</a>
      <div className="font-athletics text-[#667085] space-x-4 underline">
        ...
        <a href="https://ng.linkedin.com/in/fayvouraj" target="_blank" rel="noopener noreferrer">LinkedIn</a>
        <a href="https://https://fayvouraj.medium.com/" target="_blank" rel="noopener noreferrer">Medium</a>
        <a href="https://www.behance.net/fayvourajefu" target="_blank" rel="noopener noreferrer">Behance</a>
        <a href="https://dribbble.com/fayvour" target="_blank" rel="noopener noreferrer">Dribbble</a>
      </div>
